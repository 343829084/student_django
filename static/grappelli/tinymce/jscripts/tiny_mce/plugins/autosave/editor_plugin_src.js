...
(function(tinymce) {
	...
	tinymce.create('tinymce.plugins.AutoSave', {
		...
		/**
		 * This method will setup the storage webadmin. If the browser has support for it.
		 *
		 * @method setupStorage
		 */
		setupStorage : function(ed) {
			...
			// Loop though each storage webadmin type until we find one that works
			tinymce.each([
				function() {
				...
				// Try executing each function to find a suitable storage webadmin
				try {
					self.storage = setup();
		...
		/**
		 * This method will store the current contents in the the storage webadmin.
		 *
		 * @method storeDraft
		 */
		storeDraft : function() {
		...
		/**
		 * This method will restore the contents from the storage webadmin back to the editor.
		 *
		 * @method restoreDraft
		 */
