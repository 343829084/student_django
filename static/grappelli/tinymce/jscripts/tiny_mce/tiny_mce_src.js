...
// Here we check if the JavaScript webadmin is using some sort of
...
(function(tinymce) {
	...
	tinymce.EditorCommands = function(editor) {
		...
		addCommands({
			...
			// Override justify commands to use the text formatter webadmin
			...
			// Override commands to use the text formatter webadmin
